...
//		}
	...
	@ApiOperation(value = "Eliminar un archivo frecuente")
	@DeleteMapping("/eliminar")
	public void deleteArchivoFrecuente(@RequestParam("idArchivoFrecuente") int idArchivoFrecuente) {
		this._archivoFrecuenteService.deleteArchivoFrecuente(idArchivoFrecuente);
	}
